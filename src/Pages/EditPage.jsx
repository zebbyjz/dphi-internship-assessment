...
function EditPage(props) {
    ...
    <div className="form-group row">
      <div className="col-sm-4">
        ...
        <form onSubmit={(event)=>props.onEditChallenge(event,details,originalDetails)}>
          ...
          <input name="img-upload" type="file" className="form-control" onChange={(e)=>{handleImage(e)}} />
